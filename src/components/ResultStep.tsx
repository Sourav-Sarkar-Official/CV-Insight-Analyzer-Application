...
const ResultStep = () => {
  ...
  const handleDownloadReport = async () => {
    ...
    try {
      ...
      toast.info('Generating PDF report...', { duration: 3000 });
      
      // Allow a tiny delay for toast to render and any state updates
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8 px-4">
      <div id="report-container" className="max-w-7xl mx-auto space-y-8">
        {/* Header Section */}
        <div className="text-center space-y-4">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-full mb-4 no-print">
            <AwardIcon className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent no-print">
            Analysis Results
          </h1>
        ...
        {/* Action Buttons */}
        <Card className="bg-gradient-to-r from-blue-600 to-indigo-600 border-0 shadow-xl no-print">
          <CardContent className="p-8">
